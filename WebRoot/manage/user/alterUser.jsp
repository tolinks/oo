...
$("#content").formValidator({onshow:"请输入你的描述",onfocus:"描述至少要输入10个汉字或20个字符",oncorrect:"恭喜你,你输对了"}).inputValidator({min:20,onerror:"你输入的描述长度不正确,请确认"});	
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(${ctx }/manage/images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">修改用户</TD>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post" action="${ctx }/manage/user-manage!alter.action">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">修改用户</span></div></td>
            </tr>
          <tr>
            <td width="101" align="right">用户名:</td> 
     	 <td width="120">${userInfo.userName }</td> 
     		 <td width="342"><input type="hidden" name="id" value="${userInfo.id }" style="width:120px" /></td> 
          </tr>
          <tr>
            <td width="101" align="right">注册日期:</td> 
     	 <td width="120" colspan="2">${userInfo.createTime }</td> 
          </tr>
          <tr>
 
      <td align="right">新密码:</td> 
      <td><input type="password" name="password" id="password1" style="width:120px" value="${userInfo.userPassword }" /></td> 
      <td><div id="password1Tip" style="width:250px"></div></td> 
 
          </tr>
          <tr>
		  <td align="right">新密码确认:</td> 
     	 <td><input type="password" id="password2" style="width:120px" value="${userInfo.userPassword }"  /></td> 
      ...
      <td><div id="sexTip" style="width:250px"></div></td>
          ...
          <tr>
    	    ...
    	    <td><input type="text" id="email" name="email" style="width:120px" value="${userInfo.email }" /></td> 
     	    <td><div id="emailTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">qq:</td>
            <td><input type="text" id="qq" name="qq" style="width:120px" value="${userInfo.qq }"/></td> 
     	    <td><div id="qqTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right" valign="top">你的描述:</td> 
    	  <td colspan="2" valign="top"> <textarea id="content" name="content" cols="50" rows="10">${userInfo.content }</textarea>  
