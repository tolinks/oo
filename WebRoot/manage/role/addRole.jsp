...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">新增角色</TD>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post" action="${ctx }/manage/role-manage!save.action">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">新增角色</span></div></td>
            </tr>
          <tr>
            <td width="101" align="right">角色名:</td> 
     	 <td width="120"><input type="text" id="roleName" name="roleName" style="width:120px" value="" /></td> 
     		 <td width="342"><div id="roleNameTip" style="width:250px"></div></td> 
          </tr>
    
          <tr>
            <td align="right" valign="top">角色描述:</td> 
    	  <td colspan="2" valign="top"> <textarea id="roleInfo" name="roleInfo" cols="50" rows="10">这里是十个中文字符哦</textarea>  
