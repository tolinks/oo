...
$("#moduleInfo").formValidator({onshow:"请输入模块描述",onfocus:"描述至少要输入2个汉字",oncorrect:"恭喜你,你输对了",defaultvalue:"这家伙很懒，什么都没有留下。"}).inputValidator({min:2,onerror:"你输入的描述长度不正确,请确认"});	
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">新增模块</TD>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post" action="${ctx }/manage/module-manage!save.action">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">新增模块</span></div></td>
            </tr>
          <tr>
            <td width="101" align="right">模块名:</td> 
     	 <td width="120"><input type="text" id="moduleName" name="moduleName" style="width:120px" value="" /></td> 
     		 <td width="342"><div id="moduleNameTip" style="width:250px"></div></td> 
          </tr>
    
          <tr>
            <td align="right" valign="top">模块描述:</td> 
    	  <td colspan="2" valign="top"> <textarea id="moduleInfo" name="moduleInfo" cols="50" rows="10">这里是十个中文字符哦</textarea>  
